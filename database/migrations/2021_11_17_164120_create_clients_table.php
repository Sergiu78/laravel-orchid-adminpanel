...
class CreateClientsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('clients', function (Blueprint $table) {
            ...
            $table->enum('status', ['interviewed', 'not_interviewed'])->comment('Статус')->default('not_interviewed');
            ...
            $table->bigInteger('service_id')->comment('Нозвание указанной услуги')->unsigned()->nullable();
